...
/**
 * Resolves a message class to its Messenger transports, faithfully to Messenger's
...
final class RouteResolver
{
     ...
     * (its exact class, a parent, an interface, or a namespace wildcard). Used by
     * routing-based discovery to avoid treating every class as a message just
     * because a catch-all transport exists.
     */
