...
final class MessengerWiringPassTest extends TestCase
{
    public function testItRegistersTheProcessorFromTransportsAndRouting(): void
    {
        ...
        self::assertEquals(new Reference('asyncapi.messenger.route_resolver'), $definition->getArgument('$routeResolver'));
        ...
        // The shared resolver carries the routing map.
        self::assertSame(
            [\stdClass::class => ['events']],
            $container->getDefinition('asyncapi.messenger.route_resolver')->getArgument('$routing'),
        );
    }
    ...
    public function testTheAllowlistRestrictsDocumentedTransports(): void
    {
        ...
        // Routing is scoped too: the non-allowed transport is dropped from the resolver's map.
        self::assertSame(
            [\stdClass::class => ['events']],
            $container->getDefinition('asyncapi.messenger.route_resolver')->getArgument('$routing'),
        );
    ...
    public function testItRegistersTheRoutingProviderWhenDiscoveryIsEnabled(): void
    {
        ...
        self::assertEquals(new Reference('asyncapi.messenger.route_resolver'), $provider->getArgument('$routeResolver'));
